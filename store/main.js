...
//		  console.log(ckrecipe+" true")}else{console.log(ckrecipe+" false")};
  ...
  function GeraItMenu(){
	...
	ctItems=parseInt(ctItems)+1;
        if (appbg == "."){mainthmbk='mainthmbk'}else{mainthmbk=' ';appbg='style="background:url(\''+appbg+'\');background-repeat:no-repeat;background-align:center;background-size:auto 100%"'};
