...
//Prateleira(MENU)
  $("article").html("<div style='width:84%'><div class='poster'></div><span id='posterleft'></span><span id='posterright'></span><div class='menu'>"+acorpo+"</div></div><div class='news'></div>");acorpo="";
  CkInstall();
